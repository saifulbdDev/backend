...
trait HomeApi
{
     ...
     * get slider products
     *
     * Retrieve top 5 products with discount
     * Or retrieve top 5 latest products
     *
    ...
    public function getSliderProducts()
    {
        ...
        // select top 5 products who have active discount
        ...
        if(count($allProducts) < 5) {
            // else fetch top 5 added products
     ...
     * get latest products
     *
     * Retrieve top 8 latest products provided that each product from different category
     *
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     *
     * Retrieve featured products along with their latest products (top 4 products)
     * to be displayed in tabs in home page
     *
     * @return \Illuminate\Http\JsonResponse
     */
